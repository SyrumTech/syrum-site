import type { BrandMarkVariant } from '../types/landing';
 ...
 *
 * variant="symbol" é decorativo (alt vazio) porque o símbolo aparece como
 * elemento visual de composição, não como informação; variant="logo" carrega
 * o nome da marca e é usado dentro de um link para a página inicial.
 */
